...
export const SITE = {
  ...
  title: '大模型 · 强化学习 · AI 工程系统',
  tagline:
    '从零复现大模型训练全链路，用强化学习教会模型检索与决策，并在量化投研场景把 LLM 流水线做成可审计、人工介入最小化的工程系统。',
  description:
    '高博远（Boyuan Gao）的个人研究主页。复旦大学计算与智能创新学院硕士研究生，西安电子科技大学软件工程本科（rank 1/88）。方向：LLM 训练与对齐、强化学习、可审计的 AI 工程系统。',
  locale: 'zh-CN',
  /** 时区，用于文章日期展示 */
